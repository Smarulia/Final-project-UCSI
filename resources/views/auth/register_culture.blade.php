                ...
                <div class="row">
                    <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                        <div class="section__title-wrapper text-center mb-20">
                            <h2 class="section__title">Register as lecturer</h2>
                            <p>Kindly make your account now !</p>
                            @if ($errors->any())
                    ...
                    <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="sign__wrapper white-bg">
                            <div class="sign__form">
                                <form action="{{route("lucture.register.post")}}" method="POST">
                                    @csrf
                                    <div class="sign__input-wrapper mb-25">
                                        <h5>ID Number</h5>
                                        <div class="sign__input">
                                            <input type="number" placeholder="Input your ID number" name="id_student">
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        <h5>Password</h5>
                                        <div class="sign__input">
                                            <input type="password" placeholder="Your Password (must be 6 characters)" name="password">
                                            <i class="fal fa-lock"></i>
                                        </div>
                                    </div>
                
                                    <button class="e-btn  w-100"> <span></span>Register</button>
                                </form>
                                <p>
