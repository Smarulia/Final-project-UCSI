...
<head>
    ...
    <title>Rerservation Website (Admin)</title>
    ...
    <nav class="navbar navbar-expand-lg bg-light mb-5">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" data-page="ruangan" href="{{route( "admin.ruangan" )}}">Discussion Room</a>
                    </li>

                    <li>
                        <a class="nav-link" data-page="booking" href="{{route( "admin.request.room" )}}">Request Discussion Room </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-page="PAL" href="{{route( "admin.pal" )}}">P.A.L</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-page="booking" href="{{route( "admin.request.pal" )}}">Request P.A.L</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-page="History" href="{{ route("admin.history") }}">History</a>
                    </li>
                </ul>
            </div>
